...
(function($) {
    ...
    {
        // setup
        var opts             = $.extend({}, $.ajaxscroll.defaults, options);
        var util             = new $.ajaxscroll.util();                                // utilities module
        var paging           = new $.ajaxscroll.paging(opts.scrollContainer);          // paging module
        var hist             = (opts.history ? new $.ajaxscroll.history() : false);    // history module
        var _self            = this;
        ...
        function scroll_handler()
        {
            ...
            if (opts.scrollContainer == $.ajaxscroll.defaults.scrollContainer){
        ...
        function get_loader()
        {
            loader = $(".ajaxscroll_loader");

            if (loader.size() == 0) {
                loader = $("<div class='ajaxscroll_loader'>"+opts.loader+"</div>");
                loader.hide();
            }
            return loader;
        }
    ...
    $.ajaxscroll.history = function()
    {
        ...
        this.getState = function()
        {
            if (isHtml5) {
                ...
                if (stateObj && stateObj.ajaxscroll) return stateObj.ajaxscroll;
            }
            else {
        ...
        {
            if (isHtml5) {
                history.pushState({ ajaxscroll : stateObj }, title, url);
            }
            else {
        ...
        {
            if (isHtml5) {
                history.replaceState({ ajaxscroll : stateObj }, title, url);
            }
            else {
                this.pushState(stateObj, title, url);
            }
